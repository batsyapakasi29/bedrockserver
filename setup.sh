...
mkdir bedrockserver
cd ~/bedrockserver && wget https://www.dropbox.com/scl/fi/jz777pwnm69up0wbwsc2c/bedrock-server-1.21.51.02.zip?rlkey=toy67bfo4elc490q2tvmcklh3&st=wvh8fkj1&dl=1 && unzip bedrock-server*.zip && rm -rf bedrock-server*.zip && cd 
